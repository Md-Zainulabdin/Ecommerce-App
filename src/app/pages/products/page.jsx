...
const ProductPage = () => {
  ...
  const filterProduct = (cat) => {
    const updateProduct = product.filter((item) => item.Cat === cat);
    setFilterProd(updateProduct);
  };
      ...
      <div className="category w-[20%] h-screen overflow-hidden border-r-2">
        <div className="p-6">
          ...
          <ul className="mt-4 flex flex-col gap-3 text-lg cursor-pointer">
            <li className="py-2 border-b" onClick={() => allProducts("All")}>
              All
            </li>
            <li
            ...
            <li
              className="py-2 border-b"
              onClick={() => filterProduct("Powerbank")}
            >
              Powerbank
            </li>
            <li
              ...
              <div className="desc w-full flex flex-col items-center p-4 ">
                ...
                <div className="w-full mt-2">
                  {cart.some((p) => p.id === item.id) ? (
                    <button
                      className="w-full p-2 border text-white bg-red-400"
                      onClick={() => {
                        dispatch({
                    ...
                    <button
                      className="w-full p-2 border text-white bg-orange-400"
                      onClick={() => {
                        dispatch({
                          type: "ADD_TO_CART",
                          payload: item,
